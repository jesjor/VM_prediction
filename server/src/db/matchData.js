...
export const KNOCKOUT_MATCHES = [
  // Round of 32
  { id: 73,  round: 'R32', label: 'South Africa vs Canada',              kickoff: et('2026-06-28','15:00'), stadium: 'sofi',      home: 'South Africa', away: 'Canada' },
  { id: 74,  round: 'R32', label: 'Germany vs Paraguay',                 kickoff: et('2026-06-29','16:30'), stadium: 'gillette',  home: 'Germany',       away: 'Paraguay' },
  { id: 75,  round: 'R32', label: 'Netherlands vs Morocco',              kickoff: et('2026-06-29','21:00'), stadium: 'bbva',      home: 'Netherlands',   away: 'Morocco' },
  { id: 76,  round: 'R32', label: 'Brazil vs Japan',                     kickoff: et('2026-06-29','13:00'), stadium: 'nrg',       home: 'Brazil',        away: 'Japan' },
  { id: 77,  round: 'R32', label: 'France vs Sweden',                    kickoff: et('2026-06-30','17:00'), stadium: 'metlife',   home: 'France',        away: 'Sweden' },
  { id: 78,  round: 'R32', label: 'Ivory Coast vs Norway',               kickoff: et('2026-06-30','13:00'), stadium: 'att',       home: 'Ivory Coast',   away: 'Norway' },
  { id: 79,  round: 'R32', label: 'Mexico vs Ecuador',                   kickoff: et('2026-06-30','21:00'), stadium: 'azteca',    home: 'Mexico',        away: 'Ecuador' },
  { id: 80,  round: 'R32', label: 'England vs DR Congo',                 kickoff: et('2026-07-01','12:00'), stadium: 'mercedes',  home: 'England',       away: 'DR Congo' },
  { id: 81,  round: 'R32', label: 'USA vs Bosnia & Herzegovina',         kickoff: et('2026-07-01','20:00'), stadium: 'levis',     home: 'USA',           away: 'Bosnia & Herzegovina' },
  { id: 82,  round: 'R32', label: 'Belgium vs Senegal',                  kickoff: et('2026-07-01','16:00'), stadium: 'lumen',     home: 'Belgium',       away: 'Senegal' },
  { id: 83,  round: 'R32', label: 'Switzerland vs Algeria',              kickoff: et('2026-07-02','23:00'), stadium: 'bcplace',   home: 'Switzerland',   away: 'Algeria' },
  { id: 84,  round: 'R32', label: 'Spain vs Austria',                    kickoff: et('2026-07-02','15:00'), stadium: 'sofi',      home: 'Spain',         away: 'Austria' },
  { id: 85,  round: 'R32', label: 'Portugal vs Croatia',                 kickoff: et('2026-07-02','19:00'), stadium: 'bmo',       home: 'Portugal',      away: 'Croatia' },
  { id: 86,  round: 'R32', label: 'Argentina vs Cape Verde',             kickoff: et('2026-07-03','18:00'), stadium: 'hardrock',  home: 'Argentina',     away: 'Cape Verde' },
  { id: 87,  round: 'R32', label: 'Colombia vs Ghana',                   kickoff: et('2026-07-03','21:30'), stadium: 'arrowhead', home: 'Colombia',      away: 'Ghana' },
  { id: 88,  round: 'R32', label: 'Australia vs Egypt',                  kickoff: et('2026-07-03','14:00'), stadium: 'att',       home: 'Australia',     away: 'Egypt' },
  // Round of 16
  { id: 89,  round: 'R16', label: 'Winner: South Africa/Canada vs Winner: Germany/Paraguay', kickoff: et('2026-07-04','17:00'), stadium: 'lincoln',   homeSlot: 'W-73', awaySlot: 'W-74' },
  { id: 90,  round: 'R16', label: 'Winner: Netherlands/Morocco vs Winner: Brazil/Japan',      kickoff: et('2026-07-04','13:00'), stadium: 'nrg',       homeSlot: 'W-75', awaySlot: 'W-76' },
  { id: 91,  round: 'R16', label: 'Winner: France/Sweden vs Winner: Ivory Coast/Norway',      kickoff: et('2026-07-05','16:00'), stadium: 'metlife',   homeSlot: 'W-77', awaySlot: 'W-78' },
  { id: 92,  round: 'R16', label: 'Winner: Mexico/Ecuador vs Winner: England/DR Congo',       kickoff: et('2026-07-05','20:00'), stadium: 'azteca',    homeSlot: 'W-79', awaySlot: 'W-80' },
  { id: 93,  round: 'R16', label: 'Winner: Switzerland/Algeria vs Winner: Spain/Austria',     kickoff: et('2026-07-06','15:00'), stadium: 'att',       homeSlot: 'W-83', awaySlot: 'W-84' },
  { id: 94,  round: 'R16', label: 'Winner: USA/Bosnia vs Winner: Belgium/Senegal',            kickoff: et('2026-07-06','20:00'), stadium: 'lumen',     homeSlot: 'W-81', awaySlot: 'W-82' },
  { id: 95,  round: 'R16', label: 'Winner: Argentina/Cape Verde vs Winner: Australia/Egypt',  kickoff: et('2026-07-07','12:00'), stadium: 'mercedes',  homeSlot: 'W-86', awaySlot: 'W-88' },
  { id: 96,  round: 'R16', label: 'Winner: Portugal/Croatia vs Winner: Colombia/Ghana',       kickoff: et('2026-07-07','16:00'), stadium: 'bcplace',   homeSlot: 'W-85', awaySlot: 'W-87' },
  // Quarterfinals
